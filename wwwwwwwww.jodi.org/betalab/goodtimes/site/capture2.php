...
<!-- Mirrored from wwwwwwwww.jodi.org/betalab/goodtimes/site/capture2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 01:44:17 GMT -->
<HEAD> <META HTTP-EQUIV="Refresh" CONTENT="23; URL=index.php">
...
183233   88 -rwxr-xr-x  3 root     staff       90112 Dec 25 14:21:28 astarte A /z/x/usr_u1/local/bin/zcat
 ...
 11264   24 -rwxr-xr-x  1 root     staff       24576 Dec 25 14:22:53 astarte A /z/usr/kvm/modloa
   935    6 -rwxr-xr-x  1 root     staff        5560 Dec 25 14:23:15 astarte A /z/usr/bin/env
   105    4 -rw-r--r--  1 root     staff        3292 Dec 25 14:23:26 astarte A /z/export/root/osiris/etc/magi
...
well% 32llsds
330108.gz         hc11            newoki.tar.Z    satan.tar.Z     zap.c
...
well% 343536373839404142434445464748
u
elm
exit
l /newwell
...
key 8 de96199
elm
ccdd53  //hhoomm54ee//cc//yy55//ccyy56bbeerrttee57kkd
well% 58llssd
...
aliases.pag         in.telnetd          nw.tar.Z            tcpd.tar.Z59
...
well% 14 Feb 1995 22:10:00 PST010203040506070809101112^D^D STOP   +1.0 STOP   +1.0 STOP   +1.0 STOP   +1.0 STOP   +1.0 STOP   +1.0 STOP   +1.0 STOP 
//16hhoomm17ee//hh18//pp//19hhppccd
well# 20llss  -t-t21llaa  ||22  hheeaaddd
23total 864
...
well# 2425caca26tt  ..hhii27ssttoorryy28d
ls -la
adb -k unix.12 vmcore.12
more test.0
setenv TERM vt100
csh
exit
