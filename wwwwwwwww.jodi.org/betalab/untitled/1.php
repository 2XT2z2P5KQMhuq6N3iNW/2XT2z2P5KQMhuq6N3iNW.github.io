...
<!-- Mirrored from wwwwwwwww.jodi.org/betalab/untitled/1.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 01:43:40 GMT -->
<HEAD>
...
<title> _ </title></HEAD>
<body BGCOLOR="#cccccc" background="p/p1.jpg" link="#000000" vlink="#000000" alink="#ffffff" onLoad="startclock()">

<FORM NAME="clock" onSubmit="0"><INPUT TYPE="text" NAME="face" SIZE=12 VALUE =""></FORM>
<center>
<PRE><FORM>                                   <INPUT TYPE="radio" name="nextpage" value="1.php" CHECKED    onClick="location.replace('1.php')">
