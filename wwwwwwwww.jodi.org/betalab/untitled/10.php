...
<!-- Mirrored from wwwwwwwww.jodi.org/betalab/untitled/10.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 01:43:47 GMT -->
<HEAD>
...
<title> _ </title></HEAD>
<body BGCOLOR="#cccccc" background="p/p10.jpg" link="#000000" vlink="#000000" alink="#ffffff" onLoad="startclock()">
...
<INPUT TYPE="radio"  name="nextpage" value="6.php" onClick="location.replace('6.php')">      <INPUT TYPE="radio"  name="nextpage" value="7.php" onClick="location.replace('7.php')">                    <INPUT TYPE="radio"  name="nextpage" value="8.php" onClick="location.replace('8.php')">
              ...
              <INPUT TYPE="radio" name="nextpage" value="9.php" onClick="location.replace('9.php')">  <INPUT TYPE="radio" name="nextpage" value="10.php" CHECKED onClick="location.replace('10.php')">
...
<!-- Mirrored from wwwwwwwww.jodi.org/betalab/untitled/10.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 01:43:48 GMT -->
</HTML>