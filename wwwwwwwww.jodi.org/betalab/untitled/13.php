...
<!-- Mirrored from wwwwwwwww.jodi.org/betalab/untitled/13.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 01:43:51 GMT -->
<HEAD>
...
<title> _ </title></HEAD>
<body BGCOLOR="#cccccc" background="p/p13.jpg" link="#000000" vlink="#000000" alink="#ffffff" onLoad="startclock()">
...
<INPUT TYPE="radio" name="nextpage" value="11.php" onClick="location.replace('11.php')">                                                             <INPUT TYPE="radio" name="nextpage" value="12.php" onClick="location.replace('12.php')">     
             ...
             <INPUT TYPE="radio" name="nextpage" value="13.php" CHECKED onClick="location.replace('13.php')">                 <INPUT TYPE="radio" name="nextpage" value="14.php" onClick="location.replace('14.php')">
