...
<!-- Mirrored from wwwwwwwww.jodi.org/betalab/untitled/21.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 01:43:56 GMT -->
<HEAD>
...
<title> _ </title></HEAD>
<body BGCOLOR="#cccccc" background="p/p21.jpg" link="#000000" vlink="#000000" alink="#ffffff" onLoad="startclock()">
...
<INPUT TYPE="radio"  name="nextpage" value="2.php" onClick="location.replace('2.php')">                                       <INPUT TYPE="radio"  name="nextpage" value="3.php" onClick="location.replace('3.php')">            <INPUT TYPE="radio"  name="nextpage" value="4.php" onClick="location.replace('4.php')">
...
<INPUT TYPE="radio" name="nextpage" value="21.php" CHECKED onClick="location.replace('21.php')">         <INPUT TYPE="radio" name="nextpage" value="22.php" onClick="location.replace('22.php')">                             <INPUT TYPE="radio" name="nextpage" value="23.php" onClick="location.replace('23.php')"> 
...
<!-- Mirrored from wwwwwwwww.jodi.org/betalab/untitled/21.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Jan 2020 01:43:58 GMT -->
</HTML>